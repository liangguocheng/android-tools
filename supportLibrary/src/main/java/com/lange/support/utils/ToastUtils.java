...
public final class ToastUtils {
    ...
    private static void show(final int resId, final int duration) {
        try {
            CharSequence text = SupportUtils.getApp().getResources().getText(resId);
            show(text, duration);
    ...
    private static void show(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.makeToast(SupportUtils.getApp(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        HANDLER.post(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.newToast(SupportUtils.getApp());
                iToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) SupportUtils.getApp().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    static class ToastWithoutNotification extends AbsToast {
        ...
        private SupportUtils.OnActivityDestroyedListener listener =
                new SupportUtils.OnActivityDestroyedListener() {
                    @Override
        ...
        public void show() {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N_MR1) {
                ...
                Context topActivityOrApp = SupportUtils.getTopActivityOrApp();
                if (topActivityOrApp instanceof Activity) {
                    Activity topActivity = (Activity) topActivityOrApp;
                    mWM = topActivity.getWindowManager();
                    SupportUtils.getActivityLifecycle().addOnActivityDestroyedListener(topActivity, listener);
                }
            ...
            mParams.packageName = SupportUtils.getApp().getPackageName();
