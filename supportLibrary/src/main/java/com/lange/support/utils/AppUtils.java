package com.lange.support.utils;
...
public final class AppUtils {
    ...
    public static void registerAppStatusChangedListener(@NonNull final Object obj,
                                                        @NonNull final SupportUtils.OnAppStatusChangedListener listener) {
        SupportUtils.getActivityLifecycle().addOnAppStatusChangedListener(obj, listener);
    }
    ...
    public static void unregisterAppStatusChangedListener(@NonNull final Object obj) {
        SupportUtils.getActivityLifecycle().removeOnAppStatusChangedListener(obj);
    }
    ...
    public static void installApp(final File file) {
        ...
        SupportUtils.getApp().startActivity(getInstallAppIntent(file, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        SupportUtils.getApp().startActivity(getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean isAppInstalled(@NonNull final String packageName) {
        PackageManager packageManager = SupportUtils.getApp().getPackageManager();
        try {
    ...
    public static boolean isAppDebug() {
        return isAppDebug(SupportUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppDebug(final String packageName) {
        if (isSpace(packageName)) return false;
        try {
            PackageManager pm = SupportUtils.getApp().getPackageManager();
    ...
    public static boolean isAppSystem() {
        return isAppSystem(SupportUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        return SupportUtils.isAppForeground();
    }
    ...
    public static void launchApp(final String packageName) {
        if (isSpace(packageName)) return;
        SupportUtils.getApp().startActivity(getLaunchAppIntent(packageName, true));
    }
    ...
    public static void relaunchApp(final boolean isKillProcess) {
        PackageManager packageManager = SupportUtils.getApp().getPackageManager();
        Intent intent = packageManager.getLaunchIntentForPackage(SupportUtils.getApp().getPackageName());
        if (intent == null) return;
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        SupportUtils.getApp().startActivity(intent);
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(SupportUtils.getApp().getPackageName());
    }
    ...
    public static void launchAppDetailsSettings(final String packageName) {
        ...
        SupportUtils.getApp().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    public static void exitApp() {
        List<Activity> activityList = SupportUtils.getActivityList();
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(SupportUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return SupportUtils.getApp().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(SupportUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(SupportUtils.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(SupportUtils.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(SupportUtils.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(SupportUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(SupportUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA256() {
        return getAppSignatureSHA256(SupportUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureMD5() {
        return getAppSignatureMD5(SupportUtils.getApp().getPackageName());
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(SupportUtils.getApp().getPackageName());
    }
    ...
    private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            String authority = SupportUtils.getApp().getPackageName() + ".utilcode.provider";
            data = FileProvider.getUriForFile(SupportUtils.getApp(), authority, file);
        }
    ...
    private static Intent getLaunchAppIntent(final String packageName, final boolean isNewTask) {
        Intent intent = SupportUtils.getApp().getPackageManager().getLaunchIntentForPackage(packageName);
    ...
    private static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) SupportUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(SupportUtils.getApp().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) SupportUtils.getApp().getSystemService(Context.APP_OPS_SERVICE);
                //noinspection ConstantConditions
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) SupportUtils.getApp()
