...
public final class SupportUtils {
    ...
    private static final String PERMISSION_ACTIVITY_CLASS_NAME =
            "com.lange.support.util.util.PermissionUtils$PermissionActivity";
    ...
    static Context getTopActivityOrApp() {
        if (isAppForeground()) {
            ...
            return topActivity == null ? SupportUtils.getApp() : topActivity;
        } else {
    ...
    static boolean isAppForeground() {
        ...
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(SupportUtils.getApp().getPackageName());
            }
        }
        return false;
    }
