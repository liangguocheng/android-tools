...
import static com.lange.support.constant.PermissionConstants.Permission;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(SupportUtils.getApp().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(SupportUtils.getApp(), permission);
    }
    ...
    public static void launchAppDetailsSettings() {
        ...
        intent.setData(Uri.parse("package:" + SupportUtils.getApp().getPackageName()));
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(SupportUtils.getApp());
    }
